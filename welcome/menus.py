...
class EventType(Enum):
    ...
    def get_name(self):
        return {
            EventType.greeting: _("greeting"),
            EventType.goodbye: _("goodbye"),
            EventType.whisper_greeting: _("whisper greeting"),
        }.get(self)
...
class WelcomePages(menus.ListPageSource):
    ...
    async def format_page(self, view: BaseMenu, page: str):
        ...
        is_welcome = view.event_type in (EventType.greeting, EventType.whisper_greeting)
...
class EmbedEditModal(discord.ui.Modal):
    def __init__(self, embed_settings: dict, button: discord.ui.Button, event_type: EventType):
        ...
        self.embed_image = discord.ui.TextInput(
            ...
            if self.event_type in (EventType.greeting, EventType.whisper_greeting)
